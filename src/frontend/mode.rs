...
//             --
//             x:symbol() _ "++" _ { Expr::Assignment(x.clone(), Box::new(Expr::Add(Box::new(Expr::Identifier(x)), Box::new(Expr::Number(1.0))))) }
//             x:symbol() _ "--" _ { Expr::Assignment(x.clone(), Box::new(Expr::Sub(Box::new(Expr::Identifier(x)), Box::new(Expr::Number(1.0))))) }
//             x:symbol() _ "+=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Add(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             x:symbol() _ "-=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Sub(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             x:symbol() _ "*=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Mul(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             x:symbol() _ "/=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Div(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             x:symbol() _ "%=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Mod(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             x:symbol() _ "**=" _ y:@ { Expr::Assignment(x.clone(), Box::new(Expr::Pow(Box::new(Expr::Identifier(x)), Box::new(y)))) }
//             --
